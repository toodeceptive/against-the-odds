...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo-wide delta-only closure** (native CI, workflow docs, commands/tasks, portability, merge-gate truth)                                                        | Perfect Delta Native Guru PP Prompt           | `prompts/PERFECT_DELTA_NATIVE_GURU_PP_PROMPT_20260306.md`                                                                                                                                                                                                         |
...
| Current delta-only repo closure        | `prompts/PERFECT_DELTA_NATIVE_GURU_PP_PROMPT_20260306.md`                |
