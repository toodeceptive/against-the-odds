...
| **Audit + fix all + continuation** (deep research, guru review, PP loop, finalize and ship)                                                                       | Ultimate Follow-Up Continuation Prompt        | `prompts/ULTIMATE_FOLLOWUP_CONTINUATION_PROMPT.md` — canonical fix-all continuation flow: directive parsing, multi-perspective audit, failure-resilience fixes, verification gates, status updates, and finalization from primary path.                           |
...
| Ultimate continuation (audit + fix)   | `prompts/ULTIMATE_FOLLOWUP_CONTINUATION_PROMPT.md`              |
