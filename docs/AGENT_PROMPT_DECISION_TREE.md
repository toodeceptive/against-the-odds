...
**Exception — Fix everything / takeover**: If the user has granted **full dominion** to fix the entire project and the system is broken, read **`docs/status/HANDOFF_FOR_NEW_AGENT_202602.md`** first. Then read the **Current Operating Mode** + **Incremental Fix List** in the canonical plan (`.cursor/plans/FINAL_REPO_ORGANIZATION_AND_AUDIT.plan.md`) and execute **delta-only fixes**, not historical tracks/addendum reruns, unless live evidence shows regression.
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo-wide delta-only closure** (native CI, workflow docs, commands/tasks, portability, merge-gate truth)                                                        | New Guru Expert Team System Optimization PP Prompt | `prompts/NEW_GURU_EXPERT_TEAM_SYSTEM_OPTIMIZATION_PP_PROMPT_20260306.md`                                                                                                                                                                                          |
...
| Current delta-only repo closure        | `prompts/NEW_GURU_EXPERT_TEAM_SYSTEM_OPTIMIZATION_PP_PROMPT_20260306.md` |
