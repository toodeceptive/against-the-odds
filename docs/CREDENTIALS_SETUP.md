...
| **SHOPIFY_THEME_ID**        | **Browser**: Run `node scripts/shared/run-powershell.cjs scripts/shopify/browser/get-theme-id.ps1` (Shopify Admin must be open).                                                                                                          | Manual: `npx shopify theme list` after `npx shopify auth login`, or copy from Theme library URL.                                                                                                                                                                                         | Optional for theme dev if using theme dev by name.                                                                      |
