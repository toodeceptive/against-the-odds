...
**Theme preview shortcut (approved):** Press **Ctrl+Alt+T** (after adding the keybinding once — see [docs/KEYBINDING_PENDING_APPROVAL.md](../KEYBINDING_PENDING_APPROVAL.md)) to start the theme dev server; your browser opens the preview URL automatically. Run from repo root.
...
| **Theme preview shortcut**                   | **Ctrl+Alt+T** — start theme dev; browser opens preview URL (approved; add once per [KEYBINDING_PENDING_APPROVAL.md](../KEYBINDING_PENDING_APPROVAL.md)) |
...
| Change theme / homepage / section     | Edit theme files, show theme dev URL or diff, write pending-approval, start theme preview | Say **approve** in chat after checking the preview. **Shortcut:** **Ctrl+Alt+T** starts theme dev and opens preview in browser (add keybinding once — see [KEYBINDING_PENDING_APPROVAL.md](../KEYBINDING_PENDING_APPROVAL.md)). |
