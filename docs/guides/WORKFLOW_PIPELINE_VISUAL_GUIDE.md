...
| Verify pipeline before push           | Run `npm run verify:pipeline` (use `npm run verify:pipeline:strict` when Shopify creds are expected locally) | See [OPERATOR_RUNBOOK.md](../../OPERATOR_RUNBOOK.md) and [.github/workflows/README.md](../../.github/workflows/README.md)                                                                                                                               |
