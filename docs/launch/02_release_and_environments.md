...
- **`main`**: production (“what’s live” for the website/repo and the *production* release artifact). The deploy workflow triggers on pushes to `main`.
...
### Why it matters
- Commits you make *can be orphaned* if you don’t attach them to a branch.
