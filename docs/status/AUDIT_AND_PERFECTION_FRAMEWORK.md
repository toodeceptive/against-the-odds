...
| [scripts/run-everything-debug.ps1](../../scripts/run-everything-debug.ps1) | Parse check, Node/npm, lint, unit tests; writes docs/status/debug_sweep_*.log | Full debug sweep; comprehensive local check |
