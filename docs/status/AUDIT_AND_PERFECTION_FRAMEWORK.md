...
| CI (ci.yml)                                                                          | Lint, format check, unit tests, Trivy, secret-scan, npm audit, Lighthouse (continue-on-error) | Every push/PR to main                                         |
...
| CODEBASE_AUDIT_20260131.md, INDEX_REPORTS.md                                   | Codebase layout, scripts, tests, unupdated/irrelevant files                                                             | Track G style; Expert 3, Ultimate Audit                                                                    |
...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MASTER_10_EXPERT_SYSTEM               | Whole repo or any component: 10 sequential passes (Security → … → DevEx); discovery → analysis → optimization                                      | Run [prompts/MASTER_10_EXPERT_SYSTEM.md](../../prompts/MASTER_10_EXPERT_SYSTEM.md)                                                                                                                    |
...
**Best practice**: For "identify everything and find issues," run Phase 0 then Tracks A–G with the guru team. For a quick full-system pass or a single component, use MASTER_10_EXPERT_SYSTEM or the matching expert prompt.
...
| **Audit and analyze**                                   | Phase 0 + Tracks A–G with guru team; or MASTER_10_EXPERT_SYSTEM (full repo or single component); or matching expert prompt.                                                                   |
