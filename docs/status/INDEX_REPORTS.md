...
| **.cursor/plans/ao_agent_pp_prompt_conversion.plan.md**                    | AO Agent PP Prompt Conversion (V11): remove OpenClaw from session-start; create -pp / /pp AO prompt; 6 steps; glossary, FAQ, troubleshooting (2026-02-27)        |
