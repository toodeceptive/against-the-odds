...
- **Shopify ToS**: No headless admin automation; API + user's browser only (see [.cursor/rules/use-user-browser.mdc](../../.cursor/rules/use-user-browser.mdc), [.cursor/rules/shopify-preview-approval.mdc](../../.cursor/rules/shopify-preview-approval.mdc), [docs/security/00_security_checklist.md](../security/00_security_checklist.md)).
