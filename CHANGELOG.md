...
- **2026-01-31** — System perfection pass: AGENTS.md and .cursor/rules/agent-permissions.mdc (agent permission); docs/README.md (docs index); OPERATOR_RUNBOOK agent line and replacements.txt; README agent line, canonical scripts (sync-products.ps1/sync.ps1), docs link; .cursor/context/shopify.md product sync clarity; scripts/products/sync.ps1 portable repo root; docs/launch README 07_ note; guides last updated; docs/status/PLAN_AUDIT_20260131.md.
