...
1. **Load context**: Read [../../prompts/AO_AGENT_PP_PROMPT.md](../../prompts/AO_AGENT_PP_PROMPT.md) and invoke the prodigy-protocol skill (`../../skills/prodigy-protocol/SKILL.md`).
