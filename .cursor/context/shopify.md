...
- **Legacy bidirectional wrapper:** `scripts/products/sync.ps1` (delegates import to sync-products.ps1; keep only for import/export utility cases, not as the primary approval-gated product sync path).
