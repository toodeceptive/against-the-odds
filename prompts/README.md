...
| **PERFECT_DELTA_NATIVE_GURU_PP_PROMPT_20260306.md**                | Current best delta-only guru PP prompt for native-CI, workflow, and merge-gate closure.        |
| **NEW_GURU_EXPERT_TEAM_SYSTEM_OPTIMIZATION_PP_PROMPT_20260306.md** | Fresh-chat guru team prompt for full-system, non-redundant PP optimization cycles.             |
