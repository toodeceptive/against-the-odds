...
| `npm run setup`                  | scripts/setup/full-setup.ps1                   | Full guided setup and verification entry point                         |
| `npm run setup:auto`             | scripts/setup/auto-configure-env.ps1           | Auto-configure `.env.local`; helper for the full setup flow            |
...
| Script        | Purpose                   | When to run                                                             |
| ------------- | ------------------------- | ----------------------------------------------------------------------- |
| check-all.ps1 | Canonical quality wrapper | Runs `npm run quality`; optional npm audit output remains informational |
